(function(){
    function removeQRCode() {
        document.getElementById("QRCodifier").parentNode.removeChild(document.getElementById("QRCodifier"));
    }
    ...
    qrText.innerHTML = "Click (or press Esc key) to close";
    ...
    qrCodeDiv.onclick = removeQRCode;
